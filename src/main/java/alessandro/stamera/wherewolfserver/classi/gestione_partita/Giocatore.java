...
public final class Giocatore
{
    ...
    private boolean isProtezioneAngeloCustodeNonBucata() { return !ruolo.isContadinoLupo() && !isCappuccettoRosso(); }
    ...
    private EsitoAttacco verificaEsitoAttaccoLupi(Ruolo lupo, EsitoAttacco esito)
    {
        switch(esito)
        {
            ...
            case ULTIMO_LUPO_UCCIDE_CAPPUCCETTO_ROSSO -> { if(isAmato() || isProtezionePresente(lupo)) esito = ULTIMO_LUPO_SVEGLIA_CAPPUCCETTO_ROSSO; }
        }
        return esito;
    }
